...
class TimeSpan {
  ...
  factory TimeSpan.ofSingleField(dynamic field, num value) {
    final unit =
        timeSpanUnitOf(field) ?? (throw Exception("Invalid time span $field"));
  ...
  int get years => _values[0].toInt();

  int get months => _values[1].toInt();

  int get weeks => _values[2].toInt();

  int get days => _values[3].toInt();

  int get hours => _values[4].toInt();

  int get minutes => _values[5].toInt();
